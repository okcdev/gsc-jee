...
insert into _eppdev_conf(id, conf_name, conf_value, remarks, create_date, update_date, del_flag)
  values('0c827bc2b87343c3a09046862b5ff565', 'BASIC_PACKAGE_NAME', 'cn.gausscode.test', '包名', now(), now(), 0);

insert into _eppdev_conf(id, conf_name, conf_value, remarks, create_date, update_date, del_flag)
  values('37a102229071496eb83398e79f9acb83', 'WORK_SPACE_DIR', '/home/jinlong.hao', '开发工作目录地址', now(), now(), 0);

insert into _eppdev_conf(id, conf_name, conf_value, remarks, create_date, update_date, del_flag)
  values('7d9f3beb9d414440ab148624d63c7824', 'PROJECT_NAME', 'test', '项目名称', now(), now(), 0);

insert into _eppdev_conf(id, conf_name, conf_value, remarks, create_date, update_date, del_flag)
  values('a1e76c1791b446ca8acbbc55e7f9121f', 'AUTHOR_NAME', 'jinlong.hao', '用户名称，用于显示在注释中', now(), now(), 0);

insert into _eppdev_conf(id, conf_name, conf_value, remarks, create_date, update_date, del_flag)
  values('4a9b7721506f4b34a0ab1e7620fc1b34', 'AUTHOR_EMAIL', 'jinlong.hao@gausscode.com', '用户邮箱，用于显示在注释中', now(), now(), 0);